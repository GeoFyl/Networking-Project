...
public:
	...
	/// @brief Get the pink material.
	/// @return The reference to the pink material.
	inline const gef::Material& pink_material() const {
		return pink_material_;
	}
